...
document = {}
document.cookie='abRequestId=8a3f200b-8623-5087-97f8-d1c7305bcd28; xsecappid=xhs-pc-web; a1=197c54e15b5frzy4ggy1zbj8euco5eg627kjpadv550000291896; webId=22122229bbc80f0b7866f919b93df086; gid=yjWS24S0J4JyyjWS24dy2W0fD2iFuv4kkvyuTh2DVYd7SV28l2dkKU888JjyYjK8i8d0ydDd; webBuild=4.70.2; loadts=1751390771283; websectiga=82e85efc5500b609ac1166aaf086ff8aa4261153a448ef0be5b17417e4512f28; sec_poison_id=dfbf0c0c-f02c-4717-a30c-3f7d304968d9; unread={%22ub%22:%2268551af900000000230048ae%22%2C%22ue%22:%22685bc857000000001c0333ba%22%2C%22uc%22:19}'
documentElement={}
webgl = {
...
localStorage = {getItem:val=>{
    console.log('4',val)
        if (val === 'sdt_source_storage_key'){
            return '{"validate":false,"commonPatch":["/fe_api/burdock/v2/note/post","/api/sns/web/v1/comment/post","/api/sns/web/v1/note/like","/api/sns/web/v1/note/collect","/api/sns/web/v1/user/follow","/api/sns/web/v1/feed","/api/sns/web/v1/login/activate","/api/sns/web/v1/note/metrics_report","/api/redcaptcha","/api/store/jpd/main","/phoenix/api/strategy/getAppStrategy","/web_api/sns/v2/note"],"signUrl":"https://fe-static.xhscdn.com/as/v1/3e44/public/04b29480233f4def5c875875b6bdc3b1.js","xhsTokenUrl":"https://fe-static.xhscdn.com/as/v1/3e44/public/bf7d4e32677698655a5cadc581fd09b3.js","url":"https://fe-static.xhscdn.com/as/v1/f218/a5/public/0666f0acdeed38d4cd9084ade1739498.js","reportUrl":"/api/sec/v1/shield/webprofile","desVersion":"2","signVersion":"1","extraInfo":""}'
        }
    }}
body={}
document.body = body
...
style:{},
offsetHeight:0,
appendChild:val=>console.log('3',val)
}
// _a={tagName:'A'}
// _p={tagName:'P'}
// _h1={tagName:'H1'}
...
tebq= window._webmsxyw(args1,args2)
console.log(tebq['X-s'])
